...
export const metadata: Metadata = {
  title: 'Hey Share - Share anything instantly',
  ...
  generator: 'Next.js',
  applicationName: 'Hey Share',
  authors: [{ name: 'Talagana Rajesh', url: 'https://talaganarajesh.vercel.app/' }],
  keywords: ['file sharing', 'text sharing', 'Hey Share', 'NYAYABRATA DAS', 'instant sharing', 'no login', 'secure file transfer','Hey drop by talagana rajesh','talagana rajesh new project','hey drop rajesh','talagana rajesh file sharing website'],
  creator: 'Talagana Rajesh',
  publisher: 'Talagana Rajesh',
  metadataBase: new URL('https://heyshare.vercel.app'), // Replace with your deployed domain

  openGraph: {
    title: 'Hey Share - Share anything instantly',
    description: 'Send files or text quickly without any login or signup. One-click sharing!',
    url: 'https://heyshare.vercel.app', // Replace with your live site URL
    siteName: 'Hey Share',
    images: [
      {
